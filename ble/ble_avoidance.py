...
class BLE():
    ...
    def ble_irq(self, event, data):
        if event == 1:
            ...
            if message == "read":
                if int(sensor.value()):
                    print("Value: ", sensor.value(), "No Objected")
                    ble.send("Not Detected: "+str(sensor.value())) 
                else:
                    print("Value: ", sensor.value(), "Detected objects")
                    ble.send("Detected: "+str(sensor.value())) 
